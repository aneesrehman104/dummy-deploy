...
const Mapper = {
    ...
    1: `ipoStatus eq 'Priced' and ipoDate ge ${moment()
        .subtract(90, "days")
        .startOf("day")
        .toISOString()}`,
    2: `ipoStatus eq 'Filed' and ipoDate ge ${moment()
        .subtract(90, "days")
        .toISOString()}`,
    3: `ipoStatus eq 'Rumored' and ipoDate ge ${moment()
        .subtract(90, "days")
        .toISOString()}`,
};
        ...
        const getIPOSTradingIposPipelineOverviewData = async () => {
            ...
            try {
                const response = await getODataWithParams(URLs.ipoOdata, {
                    skip:
                        selectedTab >= 3 ? 0 : (currentPage - 1) * itemsPerPage,
                    ...
                    orderby:
                        selectedTab === 3
                            ? [
                                  {
                                      field: "percentReturnFromIpoPrice",
                                      direction: "asc",
                                  },
                              ]
                            : selectedTab === 4
